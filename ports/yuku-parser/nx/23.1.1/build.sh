...
# Final published artifact: sign it. The container builds and smoke-tests
# fine unsigned; the signature is for OHOS hosts that refuse unsigned ELF.
...
# 0005: rename to @ohos-npm-ports/nx, version 23.1.1-1, repository pointer.
...
# ("overrides": {"nx": "npm:@ohos-npm-ports/nx@..."}). Load-bearing: upstream
